(function () {
    ...
    window.BCollapsible = document.registerElement('b-collapsible', {
        prototype: Object.create(HTMLElement.prototype, {
            ...
            updateSize: {
                enumerable: true,
                value: function (size, duration, forceEnd) {
                    if (duration) {
                        this.computeSize();
                    }
